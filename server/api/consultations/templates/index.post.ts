...
const medicationSchema = z.object({
  ...
  dose: z.string().trim().max(100).nullish().transform(v => v ?? null),
  route: z.string().trim().max(100).nullish().transform(v => v ?? null),
  frequency: z.string().trim().max(100).nullish().transform(v => v ?? null),
  duration: z.string().trim().max(100).nullish().transform(v => v ?? null),
  additionalInfo: z.string().trim().max(500).nullish().transform(v => v ?? null),
